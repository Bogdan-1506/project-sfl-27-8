...
//    e.currentTarget===e.target && modalCheck('none')
//    console.log()
//})
////!Слухачі подій
...
chek.addEventListener('click',(e)=>{
    modalCheck('none')
    person.name=prompt("Введіть ім'я")
    person.password=prompt("Введіть пароль")
    console.log("Ім'я користувача: "+ person.name + " Пароль користувача: "+ person.password)
})
modal.addEventListener('click',(e)=>{
    e.currentTarget===e.target && modalCheck('none')
    console.log()
