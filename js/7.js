...
const schoolInformation={
    ...
    render(){
        while(this.play){
            //y
            let action = prompt('Введіть інформацію яку хочете отримати')
            if(action=='y'){
                this.play=false
                break
            }else if(action=='Вся інформація'){
